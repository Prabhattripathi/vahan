//
//  UsedByBodytyoeViewController.m
//  VahanIndia
//
...
#import "UsedByBodytyoeViewController.h"
#import "UsedByBodyTypeTableViewCell.h"
#import "BaseTableView.h"
#import "MBProgressHUD.h"
#import "UsedByBodytypeDetailedViewController.h"

@interface UsedByBodytyoeViewController ()
{
...
@implementation UsedByBodytyoeViewController
...
- (void)viewDidLoad
{
    ...
    [self GetBodyTypeData];

}



-(void)GetBodyTypeData

{
    ...
    array2 = [respdic valueForKey:@"body_id"];
    array1 = [respdic valueForKey:@"body_name"];
    array3 = [respdic valueForKey:@"body_image_path"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByBodyTypeTableViewCell";
    
    UsedByBodyTypeTableViewCell *cell1 = (UsedByBodyTypeTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedByBodyTypeTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.UsedCar_BodyTypeid=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
    UsedByBodytypeDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"UsedByBodytypeDetailedViewController"];
