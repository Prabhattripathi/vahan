...
#import "CarServiceStnTableViewCell.h"
#import "CarServiceStnDetailedViewController.h"
#import "DemoAppDelegate.h"

@interface CarServiceStnViewController ()
{
...
@implementation CarServiceStnViewController
...
-(void)GetCarServiceStnsData

{
    
    NSString *urlString =@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/getservicestation";
    ...
    array3 = [respdic valueForKey:@"count"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"CarServiceStnTableViewCell";
    
    CarServiceStnTableViewCell *cell1 = (CarServiceStnTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"CarServiceStnTableViewCell" owner:self options:nil];
    ...
    //for labels and count in bracket...
    cell1.lbl_name.text =[NSString stringWithFormat:@"%@ (%@)",[array1 objectAtIndex:indexPath.row],[array3 objectAtIndex:indexPath.row]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.carserviceStn_id=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
    CarServiceStnDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"CarServiceStnDetailedViewController"];
