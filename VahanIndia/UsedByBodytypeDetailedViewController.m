//
//  UsedByBodytypeDetailedViewController.m
//  VahanIndia
//
...
#import "UsedByBodyTypeDetailedTableViewCell.h"
#import "UsedCarFinallllViewController.h"


@interface UsedByBodytypeDetailedViewController ()
...
@implementation UsedByBodytypeDetailedViewController
...
- (void)viewDidLoad
{
    ...
    [HUD showAnimated:YES whileExecutingBlock:^{
        ...
        [self UsedGetBodytypeDetailedData];
...
-(void)UsedGetBodytypeDetailedData

{
    
    NSString *str=[NSString stringWithFormat:@"%@",app.UsedCar_BodyTypeid];
    ...
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_body?data={\"usedcar_body_id\":\"%@\"}",str];
    
    
    //http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_body?data={%22usedcar_body_id%22:%2215%22}
