//
//  NewsReviewsDetailedViewController.m
//  VahanIndia
//
...
#import "NewsReviewsDetailedTableViewCell.h"
...
@interface NewsReviewsDetailedViewController ()
{
    UIImage * image;
...
@implementation NewsReviewsDetailedViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"NewsReviewsDetailedTableViewCell";
    
    NewsReviewsDetailedTableViewCell *cell1 = (NewsReviewsDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"NewsReviewsDetailedTableViewCell" owner:self options:nil];
    ...
    cell1.lbl_detailNews_TITLE.text=app.NewsReviewsDetailTITLE;
    cell1.lbl_detailNews_DATE.text=app.NewsReviewsSTARTDATE;
    cell1.lbl_detailnews_username.text=app.NewsReviewsDetailUSERNAME;
    
    
    //for particular car's Image...
    
    [cell1.img_detailNews_IMG setImageWithURL:[NSURL URLWithString:app.NewsReviewsDetailIMAGE] placeholderImage:[UIImage imageNamed:@"logo.png"] usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
    
    
    
    //DYNAMIC CREATION OF "DESCRIPTION" LABEL...
    
    NSString *Descrstr=[NSString stringWithFormat:@"%@",app.NewsReviewsDetailLONGDESCRP];
    NSLog(@"app.munjisDescription:%@",app.NewsReviewsDetailLONGDESCRP);
    
    CGSize size1 = [self text:app.NewsReviewsDetailLONGDESCRP sizeWithFont:[UIFont systemFontOfSize:15] constrainedToSize:CGSizeMake(300, 3000) lineBreakMode:NSLineBreakByWordWrapping];
    
        lbl_News_longdescrr =[[UILabel alloc]initWithFrame:CGRectMake(7,300, size1.width, size1.height)];
    ...
    [app.NewsReviewsDetailLONGDESCRP stringByAddingPercentEscapesUsingEncoding:
     NSUTF8StringEncoding];
    
    NSLog(@"ajjjkl%@",app.NewsReviewsDetailLONGDESCRP);
    lbl_News_longdescrr.text=app.NewsReviewsDetailLONGDESCRP;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGSize size = [self text:app.NewsReviewsDetailLONGDESCRP sizeWithFont:[UIFont systemFontOfSize:15] constrainedToSize:CGSizeMake(300, 3000) lineBreakMode:NSLineBreakByWordWrapping];
