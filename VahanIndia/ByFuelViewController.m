...
@interface ByFuelViewController ()
{
...
@implementation ByFuelViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"ByFuelTableViewCell";
    
    ByFuelTableViewCell *cell1 = (ByFuelTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"ByFuelTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.fuel_id=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
    ByFuelDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"ByFuelDetailedViewController"];
