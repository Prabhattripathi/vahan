...
#import "UsedByPriceViewController.h"
#import "UsedByPriceTableViewCell.h"
...
@interface UsedByPriceViewController ()
{
    UIImage * image;
...
@implementation UsedByPriceViewController
...
- (void)viewDidLoad
{
    ...
    [self UsedCarGetPrizeData];

}



-(void)UsedCarGetPrizeData
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByPriceTableViewCell";
    
    UsedByPriceTableViewCell *cell1 = (UsedByPriceTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedByPriceTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.UsedCar_Priceid=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
    UsedByPriceDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"UsedByPriceDetailedViewController"];
