...
#import "UsedByCityViewController.h"
#import "UsedByCityTableViewCell.h"
#import "BaseTableView.h"
#import "MBProgressHUD.h"
#import "UsedByCityDetailedViewController.h"


@interface UsedByCityViewController ()
...
@implementation UsedByCityViewController
...

{
    ...
    NSString *urlString =@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/getcity";
    ...
    array1 = [respdic valueForKey:@"city_name"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByCityTableViewCell";
    
    UsedByCityTableViewCell *cell1 = (UsedByCityTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"ByPrizeTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.UsedCar_Cityid=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
    UsedByCityDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"UsedByCityDetailedViewController"];
