...
@interface ByPriceViewController ()
...
@implementation ByPriceViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"ByPrizeTableViewCell";
    
    ByPrizeTableViewCell *cell1 = (ByPrizeTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.price_id=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
