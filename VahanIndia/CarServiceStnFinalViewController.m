//
//  CarServiceStnFinalViewController.m
//  VahanIndia
//
...
#import "CarServiceStnFinalTableViewCell.h"


@interface CarServiceStnFinalViewController ()
{
    UIImage * image;
...
@implementation CarServiceStnFinalViewController
...
- (void)viewDidLoad
{
    ...
    [self GetCarServiceStnFinalData];
...
-(void)GetCarServiceStnFinalData

{
    
    NSString *str1=[NSString stringWithFormat:@"%@",app.carserviceStn_id];
    NSString *str2=[NSString stringWithFormat:@"%@",app.carserviceStn_Cityid];
    
    NSLog(@"Output :%@",app.carserviceStn_id);
    NSLog(@"Output :%@",app.carserviceStn_Cityid);
    
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/detail_newcar_stationscontactlist?data={\"brand_id\":\"%@\",\"city_id\":\"%@\"}",str1,str2];
    
    
    //http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/detail_newcar_stationscontactlist?data={%22brand_id%22:%2215%22,%22city_id%22:%22666%22}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"CarServiceStnFinalTableViewCell";
    
    CarServiceStnFinalTableViewCell *cell1 = (CarServiceStnFinalTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"CarServiceStnFinalTableViewCell" owner:self options:nil];
