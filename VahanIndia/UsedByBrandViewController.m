...
#import "UsedByBrandViewController.h"
#import "BaseTableView.h"
#import "UsedByBrandTableViewCell.h"
...
@interface UsedByBrandViewController ()
{
...
@implementation UsedByBrandViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByBrandTableViewCell";
    
    UsedByBrandTableViewCell *cell1 = (UsedByBrandTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedByBrandTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.UsedCar_Brandid=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
    UsedByBrandDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"UsedByBrandDetailedViewController"];
