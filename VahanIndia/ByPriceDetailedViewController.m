//
//  ByPriceDetailedViewController.m
//  VahanIndia
//
...
#import "ByPriceDetailedViewController.h"
#import "BaseTableView.h"
#import "ByPrizeTableViewCell.h"
#import "BaseTableView.h"
#import "MBProgressHUD.h"
#import "DemoAppDelegate.h"
#import "ByPriceDetailedTableViewCell.h"
#import "ByPriceFinalViewController.h"

@interface ByPriceDetailedViewController ()
{
    UIImage * image;
...
@implementation ByPriceDetailedViewController
...
-(void)GetPrizeDetailedData

{
  
    
    
    NSString *str=[NSString stringWithFormat:@"%@",app.price_id];
    
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_pricelist?data={\"price_range\":\"%@\"}",str];
    
    
    //http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_pricelist?data={%22price_range%22:%2211%22}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"ByPriceDetailedTableViewCell";
    
    ByPriceDetailedTableViewCell *cell1 = (ByPriceDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"ByPriceDetailedTableViewCell" owner:self options:nil];
