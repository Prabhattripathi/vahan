//
//  CompareCarDetailedViewController.m
//  VahanIndia
//
...
#import "CompareCarDetailedTableViewCell.h"
#import "BaseTableView.h"
...
@interface CompareCarDetailedViewController ()
{
    UIImage * image;
...
@implementation CompareCarDetailedViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"CompareCarDetailedTableViewCell";
    
    CompareCarDetailedTableViewCell *cell1 = (CompareCarDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"CompareCarDetailedTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        app.comparecar1ID=[NSString stringWithFormat:@"%@",[array_brand_id objectAtIndex:indexPath.row]];
        
        CompareCarModelDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"CompareCarModelDetailedViewController"];
