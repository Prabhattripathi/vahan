//
//  ByFuelDetailedViewController.m
//  VahanIndia
//
...
#import "ByFuelDetailedViewController.h"
#import "BaseTableView.h"
#import "MBProgressHUD.h"
#import "DemoAppDelegate.h"
#import "ByFuelDetailedTableViewCell.h"
#import "ByPriceFinalViewController.h"


@interface ByFuelDetailedViewController ()
{
    UIImage * image;
...
@implementation ByFuelDetailedViewController
...
-(void)GetFuelDetailedData

{
    
    NSString *str1=[NSString stringWithFormat:@"%@",app.fuel_id];
    NSLog(@"Output :%@",app.fuel_id);
    
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_fuel?data={\"fuel_id\":\"%@\"}",str1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"ByFuelDetailedTableViewCell";
    
    ByFuelDetailedTableViewCell *cell1 = (ByFuelDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"ByFuelDetailedTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.CarPrice=array5[indexPath.row];
