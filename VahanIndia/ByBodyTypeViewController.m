...
#import "ByBodyTypeTableViewCell.h"
#import "BaseTableView.h"
#import "MBProgressHUD.h"
#import "ByBodyTypeDetailedViewController.h"

@interface ByBodyTypeViewController ()
{
...
@implementation ByBodyTypeViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"ByBodyTypeTableViewCell";
    
    ByBodyTypeTableViewCell *cell1 = (ByBodyTypeTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"ByBodyTypeTableViewCell" owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    app.BodyType_id=[NSString stringWithFormat:@"%@",[array2 objectAtIndex:indexPath.row]];
    
     NSLog(@"Output :%@",app.BodyType_id);
    
    ByBodyTypeDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"ByBodyTypeDetailedViewController"];
