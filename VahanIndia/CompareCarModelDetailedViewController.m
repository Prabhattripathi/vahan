//
//  CompareCarModelDetailedViewController.m
//  VahanIndia
//
...
#import "CompareCarModelDetailedTableViewCell.h"
#import "BaseTableView.h"
...
@interface CompareCarModelDetailedViewController ()
{
    UIImage * image;
...
@implementation CompareCarModelDetailedViewController
...
-(void)GetCompareModelData

{
    NSString *str1=[NSString stringWithFormat:@"%@",app.comparecar1ID];
    NSLog(@"Output :%@",app.comparecar1ID);
    
    
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/modeldropdwon?data={\"brand_id\":\"%@\"}",str1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"CompareCarModelDetailedTableViewCell";
    
    CompareCarModelDetailedTableViewCell *cell1 = (CompareCarModelDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"CompareCarModelDetailedTableViewCell" owner:self options:nil];
    ...
    cell1.lbl_carModels.text=[array_model_name objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        app.comparecar2ID=[NSString stringWithFormat:@"%@",[array_model_id objectAtIndex:indexPath.row]];
        
        CompareCarVersionDetailedViewController *hvc=[self.storyboard instantiateViewControllerWithIdentifier:@"CompareCarVersionDetailedViewController"];
