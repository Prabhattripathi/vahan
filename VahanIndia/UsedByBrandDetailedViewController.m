//
//  UsedByBrandDetailedViewController.m
//  VahanIndia
//
...
#import "UsedByBrandDetailedViewController.h"
#import "BaseTableView.h"
#import "ByPrizeTableViewCell.h"
#import "MBProgressHUD.h"
#import "DemoAppDelegate.h"
#import "UsedByBrandDetailedTableViewCell.h"
#import "UsedCarFinallllViewController.h"


@interface UsedByBrandDetailedViewController ()
{
    UIImage * image;
...
@implementation UsedByBrandDetailedViewController
...
-(void)UsedGetBrandDetailedData

{
    
    NSString *str=[NSString stringWithFormat:@"%@",app.UsedCar_Brandid];
    
    //  NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_brand?data={\"usedcar_brand_id\":\"1787\"}"];
    
    
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_brand?data={\"usedcar_brand_id\":\"%@\"}",str];
    
    
    //http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_brand?data={%22usedcar_brand_id%22:%2222%22}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByBrandDetailedTableViewCell";
    
    UsedByBrandDetailedTableViewCell *cell1 = (UsedByBrandDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedByBrandDetailedTableViewCell" owner:self options:nil];
