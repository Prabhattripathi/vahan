//
//  UsedByFuelDetailedViewController.m
//  VahanIndia
//
...
#import "UsedByFuelDetailedTableViewCell.h"
#import "UsedCarFinallllViewController.h"


@interface UsedByFuelDetailedViewController ()
{
    UIImage * image;
...
@implementation UsedByFuelDetailedViewController
...
-(void)UsedGetFuelDetailedData

{
    
    NSString *str=[NSString stringWithFormat:@"%@",app.UsedCar_Fuelid];
    
    //  NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_fuel?data={\"usedcar_fuel_id\":\"1787\"}"];
    
    
    NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_fuel?data={\"usedcar_fuel_id\":\"%@\"}",str];
    
    
    //http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_fuel?data={%22usedcar_fuel_id%22:%228%22}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByFuelDetailedTableViewCell";
    
    UsedByFuelDetailedTableViewCell *cell1 = (UsedByFuelDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedByFuelDetailedTableViewCell" owner:self options:nil];
