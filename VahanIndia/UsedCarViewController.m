...
- (void)viewDidLoad
{
    ...
    ViewsArray=[[NSMutableArray alloc]initWithObjects:@"UsedByCityViewController",@"UsedByPriceViewController",@"UsedByBrandViewController",@"UsedByFuelViewController",@"UsedByBodytyoeViewController",nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedCarTableViewCell";
    
    UsedCarTableViewCell *cell1 = (UsedCarTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedCarTableViewCell" owner:self options:nil];
