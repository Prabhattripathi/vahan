//
//  UsedByCityDetailedViewController.m
//  VahanIndia
//
...
#import "UsedByCityDetailedViewController.h"
#import "BaseTableView.h"
#import "ByPrizeTableViewCell.h"
#import "MBProgressHUD.h"
#import "DemoAppDelegate.h"
#import "UsedByCityDetailedTableViewCell.h"
#import "UsedCarFinallllViewController.h"



@interface UsedByCityDetailedViewController ()
{
    UIImage * image;
...
@implementation UsedByCityDetailedViewController
...
-(void)UsedGetCityDetailedData

{
    
    NSString *str=[NSString stringWithFormat:@"%@",app.UsedCar_Cityid];
    
  //  NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_city?data={\"usedcar_city_id\":\"1787\"}"];
    
    //ids in use:- 682 1787 1431,694
    
     NSString *urlString =[NSString stringWithFormat:@"http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_city?data={\"usedcar_city_id\":\"%@\"}",str];

    
    
    //http://demo1.geniesoftsystem.com/vahanindia/api/index.php/api/filter_usedcar_city?data={%22usedcar_city_id%22:%221431%22}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *simpleTableIdentifier = @"UsedByCityDetailedTableViewCell";
    
    UsedByCityDetailedTableViewCell *cell1 = (UsedByCityDetailedTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    
    if (cell1 == nil)
    {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"UsedByCityDetailedTableViewCell" owner:self options:nil];
